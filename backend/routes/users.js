...
router.get('/', 
  ...
  async (req, res) => {
    try {
      ...
      console.log('🔍 Users search request:', { search, skills, location, filter, currentUserId });
      ...
      // Enhanced aggregation pipeline with better error handling and consistent structure
      const users = await User.aggregate([
        ...
        {
          $addFields: {
            id: '$_id' // Ensure id field exists for consistency
          }
        },
        {
          $project: {
